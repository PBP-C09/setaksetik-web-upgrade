        ...
        menuContainer.innerHTML = menus.map(menu => `
            <div class="max-w-md rounded-lg overflow-hidden shadow-lg bg-[#F5F5DC] relative border flex flex-col">
                <div class="absolute top-4 left-4 flex space-x-2 z-10">
                    <a href="/explore/edit_menu/${menu.pk}" class="bg-yellow-300 hover:bg-yellow-500 text-white rounded-full p-2 transition duration-300 shadow-lg">
                        <!-- Edit icon -->
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-9 w-9" viewBox="0 0 20 20" fill="currentColor">
                            <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z" />
                        </svg>
                    </a>
                    <a href="/explore/delete_menu/${menu.pk}" class="bg-rose-400 hover:bg-rose-600 text-white rounded-full p-2 transition duration-300 shadow-lg">
                        <!-- Delete icon -->
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-9 w-9" viewBox="0 0 20 20" fill="currentColor">
